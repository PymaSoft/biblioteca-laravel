...
<div class="form-group row">
    <label for="foto" class="col-lg-3 col-form-label">Carátula</label>
    <div class="col-lg-5">
        <input type="file" name="foto_up" id="foto" data-initial-preview="{{isset($data->foto) ? Storage::url("imagenes/caratulas/$data->foto") : "http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=Carátula+Libro"}}" accept="image/*"/>
    </div>
</div>
