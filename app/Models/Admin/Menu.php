...
{
    protected $table = "menu";      // Normalmente las tablas son en plural, para que me la reconozca en singular (obligatorio)
    protected $fillable = ['nombre', 'url', 'icono'];
    /* protected $guarded = ['id'];            // campos que laravel no permite modificar */
